...
SESSIONS_RENAME_GONE = "This conversation was deleted, so it cannot be renamed."
...
FORK_PICKER_TITLE = "Fork after an answer"
FORK_PICKER_ANSWER_TO = "Answer to: {question}"
...
FORK_NO_ANSWER = "Nothing to fork yet. You can fork after the first answer."
...
CHAT_STOPPING = "Stopping the answer. Submit again in a moment."
