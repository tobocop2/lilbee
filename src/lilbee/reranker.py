...
class Reranker:
    """Cross-encoder reranker — scores (query, chunk) pairs for precision reranking."""
...
def rerank(
    ...
    """Rerank search results using the module-level encoder."""
