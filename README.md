...
| eBook        | `.epub`, `.fb2`                                                                                                                                         | none                                                                                                                                                                                             |
| Images (OCR) | `.png`, `.jpg`, `.jpeg`, `.tiff`, `.bmp`, `.webp`, `.gif`, `.heic`, `.avif`, `.jp2`/`.j2k`/`.jpc` (JPEG-2000)                                           | [Tesseract](https://github.com/tesseract-ocr/tesseract) or a vision model                                                                                                                        |
| Text/markup  | `.md`, `.txt`, `.html`, `.rst`, `.org`, `.tex`, `.typst`                                                                                                | none                                                                                                                                                                                             |
| Data         | `.csv`, `.tsv`, `.json`, `.jsonl`, `.xml`, `.yaml`, `.toml`                                                                                             | none                                                                                                                                                                                             |
| Email        | `.eml`, `.msg`                                                                                                                                          | none                                                                                                                                                                                             |
| Archives     | `.zip`, `.tar`, `.gz`, `.7z`, `.pst` (each file inside is indexed as its own document, named `archive.zip/file.pdf`)                                    | none                                                                                                                                                                                             |
