...
[](https://www.growweedeasy.com/cannabis-plant-problems/iron-deficiency#slide_menu) [  ](https://www.growweedeasy.com "GrowWeedEasy")
  * [Home](https://www.growweedeasy.com/)
  * [Start Here](https://www.growweedeasy.com/cannabis-plant-problems/iron-deficiency)
  ...
  * [Problems & Symptoms](https://www.growweedeasy.com/cannabis-plant-problems/iron-deficiency)
  ...
  * [Tutorials](https://www.growweedeasy.com/cannabis-plant-problems/iron-deficiency)
  ...
  * [Growing Topics](https://www.growweedeasy.com/cannabis-plant-problems/iron-deficiency)
...
[](https://www.growweedeasy.com/wp-content/uploads/2016/09/iron-deficiency-yellow-new-leaves.jpg)
...
A cannabis iron nutrient deficiency can look similar to a [magnesium deficiency](https://www.growweedeasy.com/magnesium-deficiency-cannabis), but an iron deficiency will affect newer/upper/inner leaves, where a magnesium deficiency affects older/lower leaves.
...
Immediately after adding chicken manure and watering, the plant started producing bright yellow, almost white leaves that immediately dried up and died from the damage. Even though this plant was showing the signs of an iron deficiency, the iron _was_ available in the soil – the problem was that the plant just couldn’t get access to the nutrients due to nutrient lock-out conditions. In this case, grower needs to dig up the manure (since that is the real cause of this problem) & replant with good soil.
**Solution For Cannabis Iron Deficiency**
_Note:_ Sometimes a cannabis iron deficiency (like all nutrient deficiencies) can be triggered by stressful conditions, and the plant may recover on its own after the period of stress is over.
...
[Learn how to manage your pH](https://www.growweedeasy.com/how-do-i-check-the-pH-of-my-water) for growing cannabis.
...
In fact, most growers have actually already given plenty of iron to their cannabis plants since it is found abundantly in most tap water. If you’re using [quality soil](https://www.growweedeasy.com/organic-super-soil) or [cannabis-friendly nutrients](https://www.growweedeasy.com/nutrients), you probably don’t need to worry about adding more iron.
Iron deficiency symptoms caused by true lack of iron are more likely to appear when a grower is using heavily filtered or reverse osmisis (RO) water to feed plants since any iron has been removed. There are other nutrient problems that can trigger the symptoms of an iron deficiency, for example problems with with [calcium](https://www.growweedeasy.com/calcium-deficiency-cannabis) and [magnesium](https://www.growweedeasy.com/magnesium-deficiency-cannabis), or an excess of copper can all lead to symptoms of an cannabis iron deficiency.
[](https://www.amazon.com/gp/product/B00GZRKI40/ref=as_li_tl?ie=UTF8&camp=1789&creative=390957&creativeASIN=B00GZRKI40&linkCode=as2&tag=growwcom07-20&linkId=YCGB3OKNQKYVREDQ)If you suspect you have a iron deficiency even though the pH is correct, or if you believe your system is truly lacking in iron, you may want to consider flushing your system with clean, pH’d water (if on schedule, you can do this alongside a dose of your regular [nutrients](https://www.growweedeasy.com/best-marijuana-nutrients-review)) and add a supplement that contains **Iron** , **Calcium** and **Magnesium**.
...
[CaliMagic by General Hydroponics](https://amzn.to/1JXYB0O) is the calcium, magnesium, and iron
3.) Take Good Care of the Roots
Iron deficiencies can show up with the plant is having [root problems](https://www.growweedeasy.com/cannabis-root-problems) or if the plant is [overwatered](https://www.growweedeasy.com/overwatering), even if the pH is right and the iron is there. [Proper watering practices](https://www.growweedeasy.com/how-often-water-marijuana) help plants grow healthy and avoid a host of problems!
...
If you cannot get rid of a cannabis iron deficiency, please consult our [7-Step Cure to 99% of Cannabis Growing Problems](https://www.growweedeasy.com/growing-marijuana-plant-problem-deficiency)
## Plant Symptoms
...
[](https://www.growweedeasy.com/cannabis-plant-problems/iron-deficiency#slide_menu)
  * [Home](https://www.growweedeasy.com/)
  * [Start Here](https://www.growweedeasy.com/cannabis-plant-problems/iron-deficiency)
    * [The Beginner’s Guide](https://www.growweedeasy.com/basics)
    * [How to Grow Cannabis in 10 Steps](https://www.growweedeasy.com/10-step-grow-guide)
