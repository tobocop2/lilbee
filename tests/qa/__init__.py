...
* ``test_protocol_smoke.py`` hits ``/v1/chat/completions`` and
  ``/v1/messages`` directly and asserts the response envelopes match
  OpenAI and Anthropic shapes. Runs in default CI.
"""
