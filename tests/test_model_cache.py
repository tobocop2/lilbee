...
def test_cache_hit_returns_same_instance(_mem: Any, model_dir: Path) -> None:
...
@mock.patch("lilbee.providers.model_cache.get_available_memory", return_value=10 * 1024**3)
def test_different_paths_return_different_instances(_mem: Any, model_dir: Path) -> None:
    cache = MemoryAwareModelCache(loader=_fake_loader)
...
def test_lru_eviction_when_memory_tight(mock_mem: Any, model_dir: Path) -> None:
...
@mock.patch("lilbee.providers.model_cache.get_available_memory", return_value=10 * 1024**3)
def test_thread_safety(_mem: Any, model_dir: Path) -> None:
...
@mock.patch("lilbee.providers.model_cache.get_available_memory", return_value=10 * 1024**3)
def test_unload_all(_mem: Any, model_dir: Path) -> None:
    cache = MemoryAwareModelCache(loader=_fake_loader)
...
@mock.patch("lilbee.providers.model_cache.get_available_memory", return_value=10 * 1024**3)
def test_get_stats(_mem: Any, model_dir: Path) -> None:
...
def test_get_available_memory_darwin(mock_vm: Any) -> None:
...
@mock.patch("psutil.virtual_memory")
def test_get_available_memory_linux_fallback(mock_vm: Any) -> None:
...
@mock.patch("psutil.virtual_memory")
def test_get_available_memory_linux_nvidia(mock_vm: Any) -> None:
...
@mock.patch("lilbee.providers.model_cache.get_available_memory", return_value=10 * 1024**3)
def test_evict_stale_with_zero_keep_alive(_mem: Any, model_dir: Path) -> None:
...
@mock.patch("lilbee.providers.model_cache.get_available_memory", return_value=10 * 1024**3)
def test_unload_entry_no_close(_mem: Any, model_dir: Path) -> None:
...
@mock.patch("lilbee.providers.model_cache.get_available_memory", return_value=10 * 1024**3)
def test_unload_entry_close_error(_mem: Any, model_dir: Path) -> None:
