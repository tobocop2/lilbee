...
| `LILBEE_RERANK_MIN_SCORE` | `0` | Drop rerank candidates whose raw cross-encoder score falls below this, so a uniformly irrelevant pool can come back empty instead of confidently ranked. `0` disables; the scale is reranker-model specific |
