...
![pin the chat model to specific GPUs: a layout that does not fit is rejected with the exact shortfall, a working split is applied and shown on the GPU monitor](demos/tui-manual-placement.gif)
